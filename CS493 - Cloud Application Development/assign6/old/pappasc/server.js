...
var state = '';
var accessToken = '';
const clientID = '661727584854-aq8ut6bsde3p7c0g3diuvfv0gjl93eoi.apps.googleusercontent.com';
const clientSecret = 'hULpfTlU2_i5cizJvdxvy9ht';
...
app.get('/authenticator', function (req, res) {
    ...
    const redirectURL = 'https://accounts.google.com/o/oauth2/v2/auth?' + 'response_type=code&client_id=' + clientID + '&redirect_uri=https://skinnern-cs493-project6.appspot.com/middleman&scope=email&state=' + state;
...
app.get('/middleman', function (req, res) {
	...
	var options = {
		...
		redirect_uri: 'https://skinnern-cs493-project6.appspot.com/middleman',
