...
const char *WINDOWTITLE = { "Project 2 - Nicholas Skinner" };
...
//defines for the number of datapoints
...
Display()
{
	...
	*/
	...
	glLoadIdentity();
	glColor3f(1., 1., 1.);
	DoRasterString(5., 5., 0., "Nicholas Skinner CS453 Project 1");
...
InitGlui()
{
	...
	GLUI_HSlider * slider = Glui->add_slider_to_panel(panel, true, GLUI_HSLIDER_FLOAT, SLowHigh, S, (GLUI_Update_CB) Sliders );
