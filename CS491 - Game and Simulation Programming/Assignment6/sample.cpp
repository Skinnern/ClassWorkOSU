...
const char *WINDOWTITLE = { "Project 6 - Nicholas Skinner" };
...
InitGraphics( void )
{
	...
	Xpos.AddTimeValue(2.5f, 800.f);
	Xpos.AddTimeValue(   4.4f,  200.f );
	Xpos.AddTimeValue(6.f, 600.f);
	Xpos.AddTimeValue(7.5f, 100.f);
	Xpos.AddTimeValue(8.6f, 700.f);
	Xpos.AddTimeValue(10.f, 0.f);

	Ypos.AddTimeValue(    0.f,    0.f );
	Ypos.AddTimeValue(   2.5f,  300.f );
	Ypos.AddTimeValue(4.4f, 500.f);
	Ypos.AddTimeValue(6.f, 300.f);
	Ypos.AddTimeValue(7.5f, 200.f);
	Ypos.AddTimeValue(8.6f, 480.f);
	Ypos.AddTimeValue(10.f, 0.f);

	Zpos.AddTimeValue(    0.f,    0.f );
	Zpos.AddTimeValue(   2.5f, 250.f );
	Zpos.AddTimeValue(4.4f, 500.f);
	Zpos.AddTimeValue(6.f, 750.f);
	Zpos.AddTimeValue(7.5f, 1000.f);
	Zpos.AddTimeValue(8.6f, 1100.f);
	Zpos.AddTimeValue(10.f, 0.f);


	ThetaX.AddTimeValue(  0.f,    90.f );
	ThetaX.AddTimeValue( 2.5f,   180.f );
	ThetaX.AddTimeValue(4.4f, 270.f);
	ThetaX.AddTimeValue(6.f, 360.f);
	ThetaX.AddTimeValue(7.5f, 90.f);
	ThetaX.AddTimeValue(8.6f, 90.f);
	ThetaX.AddTimeValue(10.f, 90.f);


	ThetaY.AddTimeValue(  0.f,    0.f );
	ThetaY.AddTimeValue( 2.5f,  45.f );
	ThetaY.AddTimeValue(4.4f, 90.f);
	ThetaY.AddTimeValue(6.f, 45.f);
	ThetaY.AddTimeValue(7.5f, 25.f);
	ThetaY.AddTimeValue(8.6f, 55.f);
	ThetaY.AddTimeValue(10.f, 0.f);

	ThetaZ.AddTimeValue(  0.f,    0.f );
	ThetaZ.AddTimeValue( 2.5f,  180.f );
	ThetaZ.AddTimeValue(4.4f, 360.f);
	ThetaZ.AddTimeValue(6.f, 540.f);
	ThetaZ.AddTimeValue(7.5f, 720.f);
	ThetaZ.AddTimeValue(8.6f, 360.f);
...
InitLists( void )
{
	...
	{
		float xpos = Xpos.GetValue(2.5);
		float ypos = Ypos.GetValue(2.5);
		float zpos = Zpos.GetValue(2.5);
		float ax = ThetaX.GetValue(2.5);
		float ay = ThetaY.GetValue(2.5);
		float az = ThetaZ.GetValue(2.5);
		glPushMatrix();
		glTranslatef(xpos, ypos, zpos);
		glRotatef(ax, 1., 0., 0.);
		glRotatef(ay, 0., 1., 0.);
	...
	{
		float xpos = Xpos.GetValue(4.4);
		float ypos = Ypos.GetValue(4.4);
		float zpos = Zpos.GetValue(4.4);
		float ax = ThetaX.GetValue(4.4);
		float ay = ThetaY.GetValue(4.4);
		float az = ThetaZ.GetValue(4.4);
		glPushMatrix();
		glTranslatef(xpos, ypos, zpos);
		glRotatef(ax, 1., 0., 0.);
		glRotatef(ay, 0., 1., 0.);
	...
	{
		float xpos = Xpos.GetValue(8.6);
		float ypos = Ypos.GetValue(8.6);
		float zpos = Zpos.GetValue(8.6);
		float ax = ThetaX.GetValue(8.6);
		float ay = ThetaY.GetValue(8.6);
		float az = ThetaZ.GetValue(8.6);
		glPushMatrix();
		glTranslatef(xpos, ypos, zpos);
		glRotatef(ax, 1., 0., 0.);
		glRotatef(ay, 0., 1., 0.);
